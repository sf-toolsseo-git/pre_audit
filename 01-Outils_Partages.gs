        ...
        var groups = [
            ...
            },
            {
                ...
                keys: [
                    "CONTENU_YTG_CIBLE",
                    "---BORDER---",
                    "CONTENU_STRUCTURE_CLIENT", "CONTENU_STRUCTURE_CLIENT_HTML", "CONTENU_YTG_CLIENT", "CONTENU_YTG_CLIENT_HTML", "CONTENU_YTG_SCORE_CLIENT", "CONTENU_1FR_CLIENT", "CONTENU_1FR_CLIENT_HTML", "CONTENU_1FR_SCORE_CLIENT", "CONTENU_1FR_URL_CLIENT",
                    "---BORDER---",
                    "CONTENU_STRUCTURE_CONCURRENT", "CONTENU_STRUCTURE_CONCURRENT_HTML", "CONTENU_YTG_CONCURRENT", "CONTENU_YTG_CONCURRENT_HTML", "CONTENU_YTG_SCORE_CONCURRENT", "CONTENU_1FR_CONCURRENT", "CONTENU_1FR_CONCURRENT_HTML", "CONTENU_1FR_SCORE_CONCURRENT", "CONTENU_1FR_URL_CONCURRENT"
                ]
            },
            {
                name: "📦 AUTRES",
